...
export default function LandingPage({ setAuthMode }) {
        ...
        <div className="hero-inner">
          <div className="hero-left">
            ...
            <div className="hero-cta-row">
              <button className="cta-pill" onClick={() => { setAuthMode('signup'); navigate('/auth'); }}>Begin Your Analysis<span className="cta-arrow">→</span></button>
              <button className="cta-ghost" onClick={() => navigate('/scan')}>Try without account</button>
            </div>
      ...
      <section className="final-cta-section">
        <div className="final-cta-inner">
          ...
          <div className="final-btns">
            <button className="cta-pill large" onClick={() => { setAuthMode('signup'); navigate('/auth'); }}>Create Your Free Account<span className="cta-arrow">→</span></button>
            <button className="cta-ghost" onClick={() => navigate('/scan')}>Scan Without Signing Up</button>
          </div>
        </div>
